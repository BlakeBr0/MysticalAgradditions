...
public class TraitChunky extends AbstractTrait {
	...
	public void afterHit(ItemStack tool, EntityLivingBase player, EntityLivingBase target, float damageDealt, boolean wasCritical, boolean wasHit){
		...
		if(!target.isEntityAlive() && !world.isRemote){
        	...
        	if(target instanceof EntitySkeleton && ((EntitySkeleton) target).getSkeletonType() != SkeletonType.WITHER && type.SKELETON.isEnabled()){            	
        	...
        	if(target instanceof EntitySkeleton && ((EntitySkeleton) target).getSkeletonType() == SkeletonType.WITHER && type.WITHER_SKELETON.isEnabled()){            	
