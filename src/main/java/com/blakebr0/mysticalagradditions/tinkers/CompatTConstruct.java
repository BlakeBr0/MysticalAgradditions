...
//		if (!ModConfigs.confTConstructSupport || !ModChecker.TINKERS_CONSTRUCT)
//			return;
//
...
//		TinkerRegistry.addMaterialStats(prosperity, new HeadMaterialStats(36, 0.83F, 0.1F, HarvestLevels.STONE),
//				new HandleMaterialStats(0.23F, 8), new ExtraMaterialStats(20),
...
//		TinkerRegistry.addMaterialStats(soulium, new HeadMaterialStats(310, 6.35f, 4.6F, HarvestLevels.IRON),
//				new HandleMaterialStats(0.80F, 55), new ExtraMaterialStats(48), new BowMaterialStats(0.5F, 1.5F, 3.1F));
...
//		TinkerRegistry.addMaterialStats(baseEssence, new HeadMaterialStats(244, 6.65f, 4.33f, HarvestLevels.DIAMOND),
//				new HandleMaterialStats(0.7F, 65), new ExtraMaterialStats(50), new BowMaterialStats(0.5F, 1.5F, 1.02F));
...
//		TinkerRegistry.addMaterialStats(inferium, new HeadMaterialStats(345, 7.02F, 4.5F, HarvestLevels.DIAMOND),
//				new HandleMaterialStats(0.63F, 50), new ExtraMaterialStats(75),
...
//		TinkerRegistry.addMaterialStats(prudentium, new HeadMaterialStats(690, 8.01F, 6.62F, HarvestLevels.DIAMOND),
//				new HandleMaterialStats(0.78F, 75), new ExtraMaterialStats(100),
...
//		TinkerRegistry.addMaterialStats(intermedium, new HeadMaterialStats(1380, 11.08F, 9.23F, HarvestLevels.OBSIDIAN),
//				new HandleMaterialStats(0.97F, 100), new ExtraMaterialStats(150),
...
//		TinkerRegistry.addMaterialStats(superium, new HeadMaterialStats(2760, 16.53F, 11.62F, HarvestLevels.COBALT),
//				new HandleMaterialStats(1.12F, 165), new ExtraMaterialStats(225),
...
//		TinkerRegistry.addMaterialStats(supremium, new HeadMaterialStats(5520, 22.25F, 15.03F, HarvestLevels.COBALT),
//				new HandleMaterialStats(1.35F, 200), new ExtraMaterialStats(300),
