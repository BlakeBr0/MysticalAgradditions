...
//
//		NETHER_STAR("nether_star", ModBlocks.blockSpecial.getDefaultState().withProperty(BlockSpecial.VARIANT, BlockSpecial.Type.NETHER_STAR), 0, ModConfigs.confNetherStarSeeds),
//		DRAGON_EGG("dragon_egg", ModBlocks.blockSpecial.getDefaultState().withProperty(BlockSpecial.VARIANT, BlockSpecial.Type.DRAGON_EGG), 1, ModConfigs.confDragonEggSeeds),
//		AWAKENED_DRACONIUM("awakened_draconium", ModBlocks.blockSpecial.getDefaultState().withProperty(BlockSpecial.VARIANT, BlockSpecial.Type.AWAKENED_DRACONIUM), 4, ModConfigs.confAwakenedDraconiumSeeds && ModChecker.DRACONIC_EVOLUTION),
//		NEUTRONIUM("neutronium", ModBlocks.blockSpecial.getDefaultState().withProperty(BlockSpecial.VARIANT, BlockSpecial.Type.NEUTRONIUM), 5, ModConfigs.confNeutroniumSeeds && Loader.isModLoaded("avaritia"));
//
